"""
Skill schema for prompt-based autonomous agents.

Skills are now defined as:
...
class SearchStrategy(BaseModel):
    """
    Defines how a skill searches for code.
    """
...
class SkillDefinition(BaseModel):
    ...
    when_to_use: str = Field(..., description="When to select this skill (intent-based)")
